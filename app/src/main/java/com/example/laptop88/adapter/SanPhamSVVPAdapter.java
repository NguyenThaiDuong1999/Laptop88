...
public class SanPhamSVVPAdapter extends RecyclerView.Adapter<SanPhamSVVPAdapter.ViewHolder> {
    Context context;
    ArrayList<SanPham> listSanPham;
    IOnClickSanPham iOnClickSanPham;

    public SanPhamSVVPAdapter(Context context, ArrayList<SanPham> listSanPham) {
    ...
    @NonNull
    @Override
    public SanPhamSVVPAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SanPhamSVVPAdapter.ViewHolder holder, int position) {
