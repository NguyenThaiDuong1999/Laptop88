...
public class SanPhamDoanhNhanAdapter extends RecyclerView.Adapter<SanPhamDoanhNhanAdapter.ViewHolder> {
    Context context;
    ArrayList<SanPham> listSanPham;
    IOnClickSanPham iOnClickSanPham;

    public SanPhamDoanhNhanAdapter(Context context, ArrayList<SanPham> listSanPham) {
